...
@ManagedBean (name="alignmentMasterController")
@SessionScoped
public class AlignmentMasterController implements Serializable {
    ...
    @EJB private ejb.AlignmentMasterFacade ejbFacade;
    private PaginationHelper pagination;
    private int selectedItemIndex;

    public AlignmentMasterController() {
    }

    public AlignmentMaster getSelected() {
        if (current == null) {
            current = new AlignmentMaster();
            selectedItemIndex = -1;
        }
        return current;
    }

    private AlignmentMasterFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (AlignmentMaster)getItems().getRowData();
