...
@ManagedBean(name = "religionMasterController")
@SessionScoped
public class ReligionMasterController implements Serializable {
    ...
    @EJB
    private ejb.ReligionMasterFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage("ReligionMasterCreated");
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage("ReligionMasterUpdated");
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, "PersistenceErrorOccured");
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage("ReligionMasterDeleted");
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, "PersistenceErrorOccured");
        }
    }
    ...
    public static class ReligionMasterControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof ReligionMaster) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + ReligionMasterController.class.getName());
            }
        }
    }
}
