...
public class SizeMasterController implements Serializable {
    ...
    @Inject
    private com.cafeform.dndtools.ejb.SizeMasterFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage("SizeMasterCreated");
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage("SizeMasterUpdated");
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, "PersistenceErrorOccured");
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage("SizeMasterDeleted");
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, "PersistenceErrorOccured");
        }
    }
