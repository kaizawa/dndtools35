...
import com.cafeform.dndtools.entity.MonsterSkillRecord;
import com.cafeform.dndtools.mbean.util.JsfUtil;
import com.cafeform.dndtools.mbean.util.PaginationHelper;
import com.cafeform.dndtools.ejb.MonsterSkillRecordFacade;
...
public class MonsterSkillRecordController implements Serializable {
    ...
    @Inject
    private com.cafeform.dndtools.ejb.MonsterSkillRecordFacade ejbFacade;
    ...
    public MonsterSkillRecord getSelected() {
        if (current == null) {
            ...
            current.setMonsterSkillRecordPK(new com.cafeform.dndtools.entity.MonsterSkillRecordPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public static class MonsterSkillRecordControllerConverter implements Converter {
        ...
        com.cafeform.dndtools.entity.MonsterSkillRecordPK getKey(String value) {
            com.cafeform.dndtools.entity.MonsterSkillRecordPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new com.cafeform.dndtools.entity.MonsterSkillRecordPK();
            key.setMonster(Integer.parseInt(values[0]));
            key.setAbility(Integer.parseInt(values[1]));
            return key;
        }

        String getStringKey(com.cafeform.dndtools.entity.MonsterSkillRecordPK value) {
